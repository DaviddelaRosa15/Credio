...
namespace Credio.Core.Application.Features.Account.Commands.RegisterEmployee
{
    public class RegisterEmployeeCommand : IRequest<RegisterResponse>
    {
        ...
        [Required(ErrorMessage = "Debe de ingresar su rol")]
    ...
    public class RegisterEmployeeCommandHandler : IRequestHandler<RegisterEmployeeCommand, RegisterResponse>
    {
        ...
        public RegisterEmployeeCommandHandler(IAccountService accountService, IEmailService emailService, IEmailHelper emailHelper,
            IMapper mapper)
        {
